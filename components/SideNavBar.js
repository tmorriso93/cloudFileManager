...
function SideNavBar() {
  ...
  return (
    ...
    p-5"
      >
        <div className="flex justify-center items-center space-x-2 p-5">
          <Image
            src="/server002.png"
            alt="logo"
            ...
            onClick={() => router.push("/")}
          />
          <h3 className="text-[#222831] font-medium">CloudFile</h3>
        </div>
        <button
        ...
        <div className="mt-7">
          {menu.list.map((item, index) => (
            ...
            p-2 mt-3 text-gray-800 rounded-md cursor-pointer
